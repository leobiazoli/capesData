#' Data from CAPES Active Scholarships in International Mobility Programs
#'
#' The CAPES database refers to international mobility programs funded by scholarships abroad (time: 2010-2019).
#'
#' @format A data frame with 146036 rows and 58 columns.
#' \describe{
...
#' \item{VL_CAPITAL}{Amount received as capital.}
...
#' \item{VL_AUX_SEGURO_SAUDE_CAPES_SET}{Amount received as health insurance aid, paid under the CAPES/SETEC program.}
...
#' \item{VL_REDUCAO_QUADRO_PERMANENTE}{Accounting entry for the deduction of amounts paid as tuition fees to beneficiaries of the Young Talent Attraction Program who have been appointed to a permanent position in the Public Administration.}
...
#' \item{VL_DIARIAS}{Amount received as per diem.}
...
#' \item{VL_AUX_DESLOCAMENTO_PARCELA_U}{Amount received as travel allowance in a single payment.}
#' }
